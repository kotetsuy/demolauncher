...
| ポート | AIassistant | LLaVA-NPU | RealtimeDepth | EarthTourGuide | AIjukebox | AIradio | AIreversi | 3dslam3 |
|---|---|---|---|---|---|---|---|---|
| 1234 | | | | | ● | ● | | |
| 8000 | ● | | ● | ● | | | ● | |
| 8001 | ● | | | ● | | | | |
...
`:8000` を 4 デモ、`:8080` を 6 デモが取り合う。**排他起動が設計上の必須要件**で、
...
ボタンが 10 個になり 460×720 のウィンドウに収まらなくなったため、外側の
`Column` をスクロールさせている:
